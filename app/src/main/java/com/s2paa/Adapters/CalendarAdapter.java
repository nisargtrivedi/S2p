...
public void getPositionList(String date,final Activity act){
	...
	public void getPositionList(String date,final Activity act,TextView textView,TextView txt_date){
		...
		for (int i = 0; i < len; i++) {
			...
			if (date.equals(event_date)) {
				...
				//Toast.makeText(context, "You have event on this date: "+event_date, Toast.LENGTH_LONG).show();
				txt_date.setText("Date:- "+event_date);
				textView.setText("Event Detail :- "+event_message);
				CalenderActivity activity= (CalenderActivity) act;
